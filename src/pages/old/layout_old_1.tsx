            ...
            <nav className="flex justify-between p-5 max-w-7xl mx-auto">
                ...
                <div className="flex items-center space-x-5">
                    ...
                    <Link href="/" className="hidden md:block">
    					<SymbolLogo w={60} h={60}/>
    				</Link>

                    <Link href="/">
                        <LabelLogo h={50} w={110}/>
                    </Link>
                    ...
                    <div className="hidden md:block">
                        <div className="flex border-2 border-2-slate-300 rounded-md items-center justify-center">
                            ...
                            <input className="focus:outline-none p-1 px-3 w-[400px]" placeholder="Search Market"/>

                            <svg className="w-6 h-6 mr-2 text-slate-500 hover:cursor-pointer"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                ...
                <div className="flex items-center justify-center space-x-5 text-green-600">
                    <h3
                        //onHover={()=>{return console.log("onHover here");}}
                        onMouseOver={()=>{setShowUserDropdown(false)}}
                        className="hover:cursor-pointer">SignIn
                    </h3>
                    ...
                    <h3
                        onMouseOver={()=>{setShowUserDropdown(false)}}
                        className="hidden md:block border px-4 rounded-full border-green-600 hover:cursor-pointer">Sell Something
                    </h3>
                    ...
                    */}
                    ...
                    {/*breadcub menu : only shows up on mobile phones*/}
                    <div className="block md:hidden text-black hover:cursor-pointer">
                        <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
