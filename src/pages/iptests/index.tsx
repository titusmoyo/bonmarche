...
export default function Home({ trendingProducts,cartButtonColors,ip,header,req,context }: { trendingProducts: PRODUCTMODEL[],cartButtonColors:any,ip:any,header:any,req:any,context:any }) {
  return (
    <Layout childType={HOME_PAGE_INDEX}>
      ...
      <main>
        <div>
            <h3 className="text-xl">Ip Address : {ip}</h3>

            {/* header Infor*/}
            <div className="mt-[200px] mb-10 bg-slate-200 p-2">
                <div className="text-xl font-medium mb-2">Header Infor</div>
                <div>
            ...
            {/* Context */}
            <div className="mt-[200px] mb-10 bg-slate-200 p-2">
                <div className="text-xl font-medium mb-2">Req</div>
                <div>
                    <JSONTree data={req} />;
                </div>
            </div>
            ...
            {/* Context */}
            <div className="mt-[200px] mb-10 bg-slate-200 p-2">
                <div className="text-xl font-medium mb-2">Context</div>
                <div>
...
export async function getServerSideProps(context: any) {
  ...
  return {
    props: {
      ...
      req:JSON.parse(stringify(context.req, null, 2)),
      //header:context.req.headers,
      context:JSON.parse(stringify(context.req, null, 2)),
